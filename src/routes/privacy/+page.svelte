...
<Container>
	<section class="prose prose-lg w-full max-w-[unset] dark:prose-invert">
		...
		<h4>Twitch Data</h4>
		<p>
			We use and store your Twitch Data in accordance to Twitch's Web API Terms outlined <a
		...
		<p>
			Our Service will take all steps reasonably necessary to ensure that your data is treated
		...
		<p>
			Our Service may disclose your Personal Data in the good faith belief that such action is
			necessary to:
		</p>
		<ul>
			<li>To comply with a legal obligation</li>
			<li>To protect and defend the rights or property of Service</li>
		...
		<p>
			The security of data is very important to us and we are committed to protecting the
			information we collect. We exercise care in providing secure transmission and storage of
			information but remember that no method of transmission over the Internet, or method of
			electronic storage is 100% secure therefore we collect information only in a manner deemed
			reasonably necessary to serve our legitimate business purposes and comply with our legal
			obligations. We use commercially reasonable efforts to make our collection of information
			consistent with all applicable laws and regulations.
		</p>
		<p>
			You agree and accept the risks associated with the use of the internet, any transmission or
			other provision of information to our Service is done at your own risk.
		</p>
		<h2>Data Breach Policy</h2>
		<p>
			We want to ensure that your identity and data stays secure; therefore, if an incident does
			occur, we will promptly display a prominent notice on the Service to inform the affected
			individuals as may be required by law or our policies.
		</p>
		<p></p>
		<h2>Your Data Protection Rights</h2>
		<p>
			The Service would like to make sure you are fully aware of all of your data protection rights.
		...
		<ul>
			...
			<li>
				...
				information you believe is inaccurate. You also have the right to request the Service to
			...
			<li>
				The right to data portability - You have the right to request that the Service transfer the
				data that we have collected directly to you. You can find this under your user settings by
				clicking "My data".
			</li>
		</ul>
		<p>
		...
		<p>
			...
			third party link, you will be directed to that third party's website. We strongly advise you
			to review the Privacy Policy of every website you visit.
		</p>
		<p>
		...
		<p>Our Service does not knowingly address anyone under the age of 18 ("Children").</p>
		<p>
			...
			children, we take steps to remove that information from our servers.
		</p>
